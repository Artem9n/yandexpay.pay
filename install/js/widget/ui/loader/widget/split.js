...
export default class Split extends Loader {
	...
	static defaults = {
		...
		<div class="bx-yapay-skeleton">
			...
			<div class="bx-yapay-skeleton-user bx-yapay-skeleton-split">
				<div class="bx-yapay-skeleton-loading bx-yapay-skeleton-loading-circle"></div>
				<div class="bx-yapay-skeleton-loading bx-yapay-skeleton-loading-line"></div>
				<div class="bx-yapay-skeleton-loading bx-yapay-skeleton-loading-#TYPE#"></div>
			</div>
			...
			<div class="bx-yapay-skeleton-split-plan-list">
				...
				<div class="bx-yapay-skeleton-split-plan-item">
					<div class="bx-yapay-skeleton-loading bx-yapay-skeleton-loading-split-plan-payline"></div>
					<div class="bx-yapay-skeleton-loading bx-yapay-skeleton-loading-split-plan-pay"></div>
				</div>
				...
				<div class="bx-yapay-skeleton-split-plan-item">
					...
					<div class="bx-yapay-skeleton-loading bx-yapay-skeleton-split-plan-pay-date"></div>
				</div>
			</div>
	...
	render(node, data = {}) {
		...
		if (displayParameters?.TYPE_WIDGET === 'BnplRequired') {
			compileData = {
				type: 'circle-info',
				split_now: '<div class="bx-yapay-skeleton-loading bx-yapay-skeleton-loading-split-plan-plans"></div>' +
					'<div class="bx-yapay-skeleton-loading bx-yapay-skeleton-loading-split-plan-pay-now"></div>',
				split_fee: '<div class="bx-yapay-skeleton-loading bx-yapay-skeleton-loading-split-fee"></div>',
			};
