...
abstract class Base
{
	 ...
	 * */
	public static function register($agentParams = null): void
	{
	 ...
	 */
	public static function unregister($agentParams = null): void
	{
		$className = static::getClassName();
	 ...
	 * @return string|null
	 * */
	public static function callAgent($method, $arguments = null): ?string
	{
		$className = static::getClassName();
		$callResult = null;
		$result = '';
