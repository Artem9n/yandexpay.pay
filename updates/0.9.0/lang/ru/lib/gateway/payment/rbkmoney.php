...
$MESS['YANDEX_PAY_GATEWAY_PAYMENT_RBKMONEY_invoicePaymentPending'] = 'Последний запущенный платёж по указанному инвойсу ещё не достиг финального статуса. Повторите попытку позже.';
