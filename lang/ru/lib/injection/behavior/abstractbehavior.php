...
$MESS['YANDEX_PAY_INJECTION_BEHAVIOR_ABSTRACT_BEHAVIOR_HELP_SELECTOR'] = 'Укажите css селектор (селекторы через <strong>", "</strong>), куда будет привязана кнопка Yandex Pay.
