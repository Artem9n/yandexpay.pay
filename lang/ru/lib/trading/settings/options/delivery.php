...
$MESS['YANDEX_PAY_TRADING_SETTINGS_OPTIONS_DELIVERY_WAREHOUSE_FIELD_COUNTRY_REQUIRED'] = 'не заполнено поле Страна';
$MESS['YANDEX_PAY_TRADING_SETTINGS_OPTIONS_DELIVERY_WAREHOUSE_FIELD_LOCALITY_REQUIRED'] = 'не заполнено поле Город';
$MESS['YANDEX_PAY_TRADING_SETTINGS_OPTIONS_DELIVERY_WAREHOUSE_FIELD_BUILDING_REQUIRED'] = 'не заполнено поле Дом';
$MESS['YANDEX_PAY_TRADING_SETTINGS_OPTIONS_DELIVERY_WAREHOUSE_FIELD_LOCATION_LON_REQUIRED'] = 'не заполнено поле Долгота';
$MESS['YANDEX_PAY_TRADING_SETTINGS_OPTIONS_DELIVERY_WAREHOUSE_FIELD_LOCATION_LAT_REQUIRED'] = 'не заполнено поле Широта';
