...
/* ORMENTITYANNOTATION:YandexPay\Pay\Trading\Injection\RepositoryTable */
namespace YandexPay\Pay\Trading\Injection {
    /**
     * EO_Repository
     * @see \YandexPay\Pay\Trading\Injection\RepositoryTable
     *
     * Custom methods:
     * ---------------
     *
     * @method \int getId()
     * @method \YandexPay\Pay\Trading\Injection\EO_Repository setId(\int|\Bitrix\Main\DB\SqlExpression $id)
     * @method bool hasId()
     * @method bool isIdFilled()
     * @method bool isIdChanged()
     * @method \int getSetupId()
     * @method \YandexPay\Pay\Trading\Injection\EO_Repository setSetupId(\int|\Bitrix\Main\DB\SqlExpression $setupId)
     * @method bool hasSetupId()
     * @method bool isSetupIdFilled()
     * @method bool isSetupIdChanged()
     * @method \int remindActualSetupId()
     * @method \int requireSetupId()
     * @method \YandexPay\Pay\Trading\Injection\EO_Repository resetSetupId()
     * @method \YandexPay\Pay\Trading\Injection\EO_Repository unsetSetupId()
     * @method \int fillSetupId()
     * @method \string getBehavior()
     * @method \YandexPay\Pay\Trading\Injection\EO_Repository setBehavior(\string|\Bitrix\Main\DB\SqlExpression $behavior)
     * @method bool hasBehavior()
     * @method bool isBehaviorFilled()
     * @method bool isBehaviorChanged()
     * @method \string getSelector()
     * @method \YandexPay\Pay\Trading\Injection\EO_Repository setSelector(\string|\Bitrix\Main\DB\SqlExpression $selector)
     * @method bool hasSelector()
     * @method bool isSelectorFilled()
     * @method bool isSelectorChanged()
     * @method \YandexPay\Pay\Trading\Setup\Model getSetup()
     * @method \YandexPay\Pay\Trading\Setup\Model remindActualSetup()
     * @method \YandexPay\Pay\Trading\Setup\Model requireSetup()
     * @method \YandexPay\Pay\Trading\Injection\EO_Repository setSetup(\YandexPay\Pay\Trading\Setup\Model $object)
     * @method \YandexPay\Pay\Trading\Injection\EO_Repository resetSetup()
     * @method \YandexPay\Pay\Trading\Injection\EO_Repository unsetSetup()
     * @method bool hasSetup()
     * @method bool isSetupFilled()
     * @method bool isSetupChanged()
     * @method \YandexPay\Pay\Trading\Setup\Model fillSetup()
     ...
     * @method bool isFilled($fieldName)
     * @method bool isChanged($fieldName)
     * @method \YandexPay\Pay\Trading\Injection\EO_Repository set($fieldName, $value)
     * @method \YandexPay\Pay\Trading\Injection\EO_Repository reset($fieldName)
     * @method \YandexPay\Pay\Trading\Injection\EO_Repository unset($fieldName)
     * @method void addTo($fieldName, $value)
     * @method void removeFrom($fieldName, $value)
     * @method void removeAll($fieldName)
     * @method \Bitrix\Main\ORM\Data\Result delete()
     ...
     * @method mixed[] collectValues($valuesType = \Bitrix\Main\ORM\Objectify\Values::ALL, $fieldsMask = \Bitrix\Main\ORM\Fields\FieldTypeMask::ALL)
     * @method \Bitrix\Main\ORM\Data\AddResult|\Bitrix\Main\ORM\Data\UpdateResult|\Bitrix\Main\ORM\Data\Result save()
     * @method static \YandexPay\Pay\Trading\Injection\EO_Repository wakeUp($data)
     */
    class EO_Repository {
        /* @var \YandexPay\Pay\Trading\Injection\RepositoryTable */
        static public $dataClass = '\YandexPay\Pay\Trading\Injection\RepositoryTable';
        /**
         * @param bool|array $setDefaultValues
         */
        public function __construct($setDefaultValues = true) {}
...
namespace YandexPay\Pay\Trading\Injection {
     ...
     * @method \string[] getSelectorList()
     * @method \YandexPay\Pay\Trading\Setup\Model[] getSetupList()
     * @method \YandexPay\Pay\Trading\Injection\EO_Repository_Collection getSetupCollection()
     * @method \YandexPay\Pay\Trading\Setup\Collection fillSetup()
     *
     * Common methods:
     * ---------------
     *
     * @property-read \Bitrix\Main\ORM\Entity $entity
     * @method void add(\YandexPay\Pay\Trading\Injection\EO_Repository $object)
     * @method bool has(\YandexPay\Pay\Trading\Injection\EO_Repository $object)
     * @method bool hasByPrimary($primary)
     * @method \YandexPay\Pay\Trading\Injection\EO_Repository getByPrimary($primary)
     * @method \YandexPay\Pay\Trading\Injection\EO_Repository[] getAll()
     * @method bool remove(\YandexPay\Pay\Trading\Injection\EO_Repository $object)
     * @method void removeByPrimary($primary)
     * @method void fill($fields = \Bitrix\Main\ORM\Fields\FieldTypeMask::ALL) flag or array of field names
     * @method static \YandexPay\Pay\Trading\Injection\EO_Repository_Collection wakeUp($data)
     * @method \Bitrix\Main\ORM\Data\Result save($ignoreEvents = false)
     * @method void offsetSet() ArrayAccess
     * @method void offsetExists() ArrayAccess
     * @method void offsetUnset() ArrayAccess
     * @method void offsetGet() ArrayAccess
     * @method void rewind() Iterator
     * @method \YandexPay\Pay\Trading\Injection\EO_Repository current() Iterator
     * @method mixed key() Iterator
     * @method void next() Iterator
     * @method bool valid() Iterator
     * @method int count() Countable
...
namespace YandexPay\Pay\Trading\Injection {
     ...
     * @method static EO_Repository_Result getList(array $parameters = array())
     * @method static EO_Repository_Entity getEntity()
     * @method static \YandexPay\Pay\Trading\Injection\EO_Repository createObject($setDefaultValues = true)
     * @method static \YandexPay\Pay\Trading\Injection\EO_Repository_Collection createCollection()
     * @method static \YandexPay\Pay\Trading\Injection\EO_Repository wakeUpObject($row)
     * @method static \YandexPay\Pay\Trading\Injection\EO_Repository_Collection wakeUpCollection($rows)
     */
    class RepositoryTable extends \Bitrix\Main\ORM\Data\DataManager {}
    /**
     * Common methods:
     ...
     *
     * @method EO_Repository_Result exec()
     * @method \YandexPay\Pay\Trading\Injection\EO_Repository fetchObject()
     * @method \YandexPay\Pay\Trading\Injection\EO_Repository_Collection fetchCollection()
     *
     * Custom methods:
     * ---------------
     *
    ...
    class EO_Repository_Result extends \Bitrix\Main\ORM\Query\Result {}
    /**
     * @method \YandexPay\Pay\Trading\Injection\EO_Repository createObject($setDefaultValues = true)
     * @method \YandexPay\Pay\Trading\Injection\EO_Repository_Collection createCollection()
     * @method \YandexPay\Pay\Trading\Injection\EO_Repository wakeUpObject($row)
     * @method \YandexPay\Pay\Trading\Injection\EO_Repository_Collection wakeUpCollection($rows)
     */
    class EO_Repository_Entity extends \Bitrix\Main\ORM\Entity {}
}